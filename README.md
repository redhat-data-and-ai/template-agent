...
| `GOOGLE_APPLICATION_CREDENTIALS_CONTENT` | — | Inline service account JSON (fallback when ADC is unavailable) |
| `GOOGLE_APPLICATION_CREDENTIALS` | — | Path to ADC file (set automatically in discover-agent-deploy compose) |
