...
class TestFeedbackRoute:
    ...
    @patch("template_agent.src.routes.feedback.get_langfuse_client")
    def test_feedback_endpoint_success(self, mock_get_client):
        ...
        mock_langfuse = mock_get_client.return_value
        mock_langfuse.score.return_value = None
    ...
    @patch("template_agent.src.routes.feedback.get_langfuse_client")
    def test_feedback_endpoint_minimal_data(self, mock_get_client):
